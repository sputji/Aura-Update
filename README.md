...
Comment l'utiliser :
1. Téléchargez le fichier Aura-Update.exe depuis la page des versions (Releases) de ce dépôt GitHub.
2. Lancez l'exécutable Aura-Update.exe pour démarrer le programme.
3. L'interface graphique s'ouvrira, affichant les mises à jour disponibles.
4. Cliquez sur "Vérifier les mises à jour" pour commencer.
5. Choisissez de mettre à jour un programme spécifique ou de tout installer d'un coup.
